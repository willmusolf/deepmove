...
- {elo}-rated player
- {time_control} game
- student played as {color} — every lesson addresses THIS player's moves only
- opponent played as {opponent_color}
- move {move_number} in the {game_phase}
- student played {move_played}
- category: {category}
...
WRITE 2-4 SENTENCES.
Sentence 1 must say what went wrong — reference a specific piece, square, or eval number from VERIFIED DATA.
Do NOT give generic advice that could apply to any game. Every sentence must be grounded in the specific position above.
...
Last sentence must give one concrete rule for the student's next game."""
